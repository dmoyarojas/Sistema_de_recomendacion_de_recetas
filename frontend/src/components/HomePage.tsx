          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <p className="mb-8 text-lg text-gray-600">
                Ingresa los ingredientes que tienes disponibles y descubre
                recetas deliciosas que puedes preparar ahora mismo. Sin
                complicaciones, sin desperdicios.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    document
                      .getElementById("popular-recipes")
...
function FeatureStat({
  ...
  return (
    <div className="text-center">
      <div className="mb-2 flex justify-center text-[#e87c3e]">{icon}</div>
